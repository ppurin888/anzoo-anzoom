...
import com.anzoo_anzoom.database.information_schema.tables.records.EnabledRolesRecord;
...
public class EnabledRoles extends TableImpl<EnabledRolesRecord> {
    ...
    private static final long serialVersionUID = -2106698637;
     ...
     */
    public final TableField<EnabledRolesRecord, String> ROLE_NAME = createField("ROLE_NAME", org.jooq.impl.SQLDataType.VARCHAR(128).defaultValue(org.jooq.impl.DSL.inline("NULL", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
