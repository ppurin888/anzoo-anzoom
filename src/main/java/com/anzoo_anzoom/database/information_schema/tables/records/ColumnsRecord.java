...
public class ColumnsRecord extends TableRecordImpl<ColumnsRecord> implements Record22<String, String, String, String, ULong, String, String, String, ULong, ULong, ULong, ULong, ULong, String, String, String, String, String, String, String, String, String> {

    private static final long serialVersionUID = 828730574;
     ...
     */
    @Override
    public Row22<String, String, String, String, ULong, String, String, String, ULong, ULong, ULong, ULong, ULong, String, String, String, String, String, String, String, String, String> valuesRow() {
     ...
     */
    @Override
    public ColumnsRecord value22(String value) {
