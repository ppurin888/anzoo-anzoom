...
import com.anzoo_anzoom.database.information_schema.tables.records.TableStatisticsRecord;
...
public class TableStatistics extends TableImpl<TableStatisticsRecord> {
    ...
    private static final long serialVersionUID = 2127582610;
     ...
     */
    public final TableField<TableStatisticsRecord, String> TABLE_SCHEMA = createField("TABLE_SCHEMA", org.jooq.impl.SQLDataType.VARCHAR(192).nullable(false).defaultValue(org.jooq.impl.DSL.inline("''", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>information_schema.TABLE_STATISTICS.TABLE_NAME</code>.
     */
    public final TableField<TableStatisticsRecord, String> TABLE_NAME = createField("TABLE_NAME", org.jooq.impl.SQLDataType.VARCHAR(192).nullable(false).defaultValue(org.jooq.impl.DSL.inline("''", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>information_schema.TABLE_STATISTICS.ROWS_READ</code>.
     */
    public final TableField<TableStatisticsRecord, Long> ROWS_READ = createField("ROWS_READ", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.BIGINT)), this, "");

    /**
     * The column <code>information_schema.TABLE_STATISTICS.ROWS_CHANGED</code>.
     */
    public final TableField<TableStatisticsRecord, Long> ROWS_CHANGED = createField("ROWS_CHANGED", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.BIGINT)), this, "");

    /**
     * The column <code>information_schema.TABLE_STATISTICS.ROWS_CHANGED_X_INDEXES</code>.
     */
    public final TableField<TableStatisticsRecord, Long> ROWS_CHANGED_X_INDEXES = createField("ROWS_CHANGED_X_INDEXES", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.BIGINT)), this, "");
