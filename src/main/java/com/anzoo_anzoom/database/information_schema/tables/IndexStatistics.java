...
import com.anzoo_anzoom.database.information_schema.tables.records.IndexStatisticsRecord;
...
public class IndexStatistics extends TableImpl<IndexStatisticsRecord> {
    ...
    private static final long serialVersionUID = -120975662;
     ...
     */
    public final TableField<IndexStatisticsRecord, String> TABLE_SCHEMA = createField("TABLE_SCHEMA", org.jooq.impl.SQLDataType.VARCHAR(192).nullable(false).defaultValue(org.jooq.impl.DSL.inline("''", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>information_schema.INDEX_STATISTICS.TABLE_NAME</code>.
     */
    public final TableField<IndexStatisticsRecord, String> TABLE_NAME = createField("TABLE_NAME", org.jooq.impl.SQLDataType.VARCHAR(192).nullable(false).defaultValue(org.jooq.impl.DSL.inline("''", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>information_schema.INDEX_STATISTICS.INDEX_NAME</code>.
     */
    public final TableField<IndexStatisticsRecord, String> INDEX_NAME = createField("INDEX_NAME", org.jooq.impl.SQLDataType.VARCHAR(192).nullable(false).defaultValue(org.jooq.impl.DSL.inline("''", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>information_schema.INDEX_STATISTICS.ROWS_READ</code>.
     */
    public final TableField<IndexStatisticsRecord, Long> ROWS_READ = createField("ROWS_READ", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.BIGINT)), this, "");
